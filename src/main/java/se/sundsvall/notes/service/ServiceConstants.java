...
public class ServiceConstants {
	...
	static final String EVENT_LOG_CREATE_NOTE = "Anteckningen har skapats.";
	static final String EVENT_LOG_UPDATE_NOTE = "Anteckningen har uppdaterats.";
	static final String EVENT_LOG_DELETE_NOTE = "Anteckningen har raderats.";
}
